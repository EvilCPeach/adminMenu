  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          ?>
          <li class="nav-item">
            <a href="<?php echo $page['link-page'] ?>" class="nav-link"><?php echo $page['name-page'] ?></a>
          </li>
          <?php } ?>
        </li>
      </ul>
    ...
    <section class="buttons vh-100 w-100 d-flex justify-content-center align-items-center">
        <form action="../functions/createPage.php" method="GET" class="d-flex flex-column">
          ...
          <input type="submit" class="btn btn-success" id="createButton" value="Создать страницу"></input>
        </form>
    </section>
